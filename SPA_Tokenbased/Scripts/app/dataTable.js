        ...
        init: function (options) {
            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    "scope": null,
                    "compiler": null,
                    "dom": "<'row'<'col-md-8 col-sm-12'><'col-md-4 col-sm-12'<'table-group-actions pull-right'>>r><'table-noborder't><'row'<'col-md-12 col-sm-12'pli><'col-md-4 col-sm-12'>>", // datatable layout
